...
import { areRectSnapshotsEqual, createRectSnapshotsByAnnotationId, createSelectionPayloadFromActiveObject } from "./history.js";
...
export function createDetectionCanvasWorkflow(state, deps, shell) {
