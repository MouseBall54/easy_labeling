function parseLegacyYoloFloat(value) {
    return parseFloat(String(value));
}
export function parseYoloRows(yoloData, imgWidth, imgHeight) {
...
export function serializeRectsToYolo(rects, imgWidth, imgHeight) {
    let yoloString = "";
    rects.forEach((rect) => {
