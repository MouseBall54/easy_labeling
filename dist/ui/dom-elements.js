...
export function getDOMElements(documentRef, bootstrapRef) {
    ...
    return {
        ...
        detectionWorkflowTab: requireById(documentRef, "detectionWorkflowTab"),
        segmentationWorkflowTab: requireById(documentRef, "segmentationWorkflowTab"),
        reviewWorkflowTab: requireById(documentRef, "reviewWorkflowTab"),
        detectionWorkflowPanel: requireById(documentRef, "detectionWorkflowPanel"),
        segmentationWorkflowPanel: requireById(documentRef, "segmentationWorkflowPanel"),
        reviewWorkflowPanel: requireById(documentRef, "reviewWorkflowPanel"),
        ...
        undoBtn: requireById(documentRef, "undoBtn"),
        redoBtn: requireById(documentRef, "redoBtn"),
        alignLeftBtn: requireById(documentRef, "alignLeftBtn"),
        alignRightBtn: requireById(documentRef, "alignRightBtn"),
        alignTopBtn: requireById(documentRef, "alignTopBtn"),
        alignBottomBtn: requireById(documentRef, "alignBottomBtn"),
        distributeHorizontalBtn: requireById(documentRef, "distributeHorizontalBtn"),
        distributeVerticalBtn: requireById(documentRef, "distributeVerticalBtn"),
        ...
        segmentationBrushModeBtn: requireById(documentRef, "segmentationBrushModeBtn"),
        segmentationEraseModeBtn: requireById(documentRef, "segmentationEraseModeBtn"),
        segmentationToolSizeLabel: requireById(documentRef, "segmentationToolSizeLabel"),
        segmentationToolSizeSlider: requireById(documentRef, "segmentationToolSizeSlider"),
        segmentationToolSizeValue: requireById(documentRef, "segmentationToolSizeValue"),
        segmentationToolSizePresets: requireById(documentRef, "segmentationToolSizePresets"),
        segmentationActiveClassSummary: requireById(documentRef, "segmentationActiveClassSummary"),
        segmentationRelabelRegionBtn: requireById(documentRef, "segmentationRelabelRegionBtn"),
        segmentationMaskVisibilityToggle: requireById(documentRef, "segmentationMaskVisibilityToggle"),
        segmentationMaskOpacitySlider: requireById(documentRef, "segmentationMaskOpacitySlider"),
        segmentationMaskOpacityValue: requireById(documentRef, "segmentationMaskOpacityValue"),
        segmentationClassSummary: requireById(documentRef, "segmentationClassSummary"),
        reviewTargetSelect: requireById(documentRef, "reviewTargetSelect"),
        reviewStatusUntouched: requireById(documentRef, "reviewStatusUntouched"),
        reviewStatusApproved: requireById(documentRef, "reviewStatusApproved"),
        reviewStatusNeedsFix: requireById(documentRef, "reviewStatusNeedsFix"),
        reviewIssueChecklist: requireById(documentRef, "reviewIssueChecklist"),
        reviewApproveBtn: requireById(documentRef, "reviewApproveBtn"),
        reviewNeedsFixBtn: requireById(documentRef, "reviewNeedsFixBtn"),
